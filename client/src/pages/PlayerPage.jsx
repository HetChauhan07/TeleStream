...
export default function PlayerPage() {
  ...
  return (
    <div className="player-page" id="player-page">
      <button className="player-page__back" onClick={handleBack} style={{ zIndex: 30 }}>
      ...
      {movie && (
        <div className="player-page__title-bar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }} onClick={(e) => e.stopPropagation()}>
